...
export const Close: React.SFC<CloseProps> = ({ onClick }) => {
  return (
    <div className={cx("sj-overlay__close", container)} onClick={onClick}>
      <div className={cx("sj-overlay__close__cross")}>
        <Cross />
      </div>
      <div className={cx("sj-overlay__close__esc", esc)}>ESC</div>
    </div>
  );
};
